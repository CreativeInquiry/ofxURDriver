...
void URMove::addTargetJointPose(vector<double> _target){
    targetPose = _target;
}

vector<double> URMove::getTargetJointPose(){
    return targetPose;
}
...
vector<double> URMove::getCurrentJointVelocities(){
    return currentJointVelocity;
}


void URMove::setCurrentJointPose(vector<double> & pose) {
